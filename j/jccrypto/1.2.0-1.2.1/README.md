# Comparing `tmp/jccrypto-1.2.0-py3-none-any.whl.zip` & `tmp/jccrypto-1.2.1-py3-none-any.whl.zip`
...
## Comparing `jccrypto-1.2.0.dist-info/METADATA` & `jccrypto-1.2.1.dist-info/METADATA`
