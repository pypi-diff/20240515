# Comparing `tmp/ilo-0.0.25.tar.gz` & `tmp/ilo-0.0.9.tar.gz`

## filetype from file(1)

```diff
@@ -1 +1 @@
-gzip compressed data, was "ilo-0.0.25.tar", last modified: Wed May 15 10:09:18 2024, max compression
+gzip compressed data, was "ilo-0.0.9.tar", last modified: Thu Dec 16 12:00:24 2021, max compression
```

## Comparing `ilo-0.0.25.tar` & `ilo-0.0.9.tar`

### file list

```diff
@@ -1,13 +1,12 @@
-drwxrwxrwx   0        0        0        0 2024-05-15 10:09:18.112667 ilo-0.0.25/
--rw-rw-rw-   0        0        0     2156 2024-05-15 10:09:18.111668 ilo-0.0.25/PKG-INFO
--rw-rw-rw-   0        0        0     1589 2024-05-02 14:19:59.000000 ilo-0.0.25/README.md
-drwxrwxrwx   0        0        0        0 2024-05-15 10:09:18.081775 ilo-0.0.25/libname/
-drwxrwxrwx   0        0        0        0 2024-05-15 10:09:18.110672 ilo-0.0.25/libname/ilo.egg-info/
--rw-rw-rw-   0        0        0     2156 2024-05-15 10:09:17.000000 ilo-0.0.25/libname/ilo.egg-info/PKG-INFO
--rw-rw-rw-   0        0        0      207 2024-05-15 10:09:17.000000 ilo-0.0.25/libname/ilo.egg-info/SOURCES.txt
--rw-rw-rw-   0        0        0        1 2024-05-15 10:09:17.000000 ilo-0.0.25/libname/ilo.egg-info/dependency_links.txt
--rw-rw-rw-   0        0        0        9 2024-05-15 10:09:17.000000 ilo-0.0.25/libname/ilo.egg-info/requires.txt
--rw-rw-rw-   0        0        0        4 2024-05-15 10:09:17.000000 ilo-0.0.25/libname/ilo.egg-info/top_level.txt
--rw-rw-rw-   0        0        0    23490 2024-05-15 10:04:54.000000 ilo-0.0.25/libname/ilo.py
--rw-rw-rw-   0        0        0       42 2024-05-15 10:09:18.112667 ilo-0.0.25/setup.cfg
--rw-rw-rw-   0        0        0      936 2024-05-15 10:05:42.000000 ilo-0.0.25/setup.py
...
### Comparing `ilo-0.0.25/setup.py` & `ilo-0.0.9/setup.py`
