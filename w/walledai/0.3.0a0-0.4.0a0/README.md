# Comparing `tmp/walledai-0.3.0a0.tar.gz` & `tmp/walledai-0.4.0a0.tar.gz`
...
### Comparing `walledai-0.3.0a0/src/walledai/_types.py` & `walledai-0.4.0a0/src/walled_ai/_types.py`
