# Comparing `tmp/walledai-0.5.0a0.tar.gz` & `tmp/walledai-0.6.0a0.tar.gz`
...
### Comparing `walledai-0.5.0a0/src/walledai/_resource.py` & `walledai-0.6.0a0/src/walledai/_resource.py`
