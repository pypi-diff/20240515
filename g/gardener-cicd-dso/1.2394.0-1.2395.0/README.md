# Comparing `tmp/gardener_cicd_dso-1.2394.0.tar.gz` & `tmp/gardener_cicd_dso-1.2395.0.tar.gz`
...
### Comparing `gardener_cicd_dso-1.2394.0/clamav/model.py` & `gardener_cicd_dso-1.2395.0/clamav/model.py`
