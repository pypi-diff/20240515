# Comparing `tmp/ImageDimensionCheck-1.1-py3-none-any.whl.zip` & `tmp/ImageDimensionCheck-1.2-py3-none-any.whl.zip`
...
## Comparing `ImageDimensionCheck-1.1.dist-info/License.txt` & `ImageDimensionCheck-1.2.dist-info/License.txt`
