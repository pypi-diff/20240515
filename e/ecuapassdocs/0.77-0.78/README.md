# Comparing `tmp/ecuapassdocs-0.77.tar.gz` & `tmp/ecuapassdocs-0.78.tar.gz`
...
### Comparing `ecuapassdocs-0.77/ecuapassdocs/info/ecuapass_feedback.py` & `ecuapassdocs-0.78/ecuapassdocs/info/ecuapass_feedback.py`
