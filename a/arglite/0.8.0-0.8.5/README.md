# Comparing `tmp/arglite-0.8.0-py3-none-any.whl.zip` & `tmp/arglite-0.8.5-py3-none-any.whl.zip`

## zipinfo {}

```diff
@@ -1,11 +1,11 @@
-Zip file size: 5624 bytes, number of entries: 9
--rw-r--r--  2.0 unx       43 b- defN 24-Feb-24 22:29 arglite/__init__.py
--rw-r--r--  2.0 unx     5124 b- defN 24-Feb-24 23:00 arglite/arglite.py
--rw-r--r--  2.0 unx      824 b- defN 24-Feb-24 22:29 arglite/argument.py
--rw-r--r--  2.0 unx     1037 b- defN 24-Feb-24 22:29 arglite/code.py
--rw-r--r--  2.0 unx     1211 b- defN 24-Feb-25 15:32 arglite-0.8.0.dist-info/LICENSE
--rw-r--r--  2.0 unx      785 b- defN 24-Feb-25 15:32 arglite-0.8.0.dist-info/METADATA
--rw-r--r--  2.0 unx       92 b- defN 24-Feb-25 15:32 arglite-0.8.0.dist-info/WHEEL
--rw-r--r--  2.0 unx        8 b- defN 24-Feb-25 15:32 arglite-0.8.0.dist-info/top_level.txt
-?rw-rw-r--  2.0 unx      680 b- defN 24-Feb-25 15:32 arglite-0.8.0.dist-info/RECORD
-9 files, 9804 bytes uncompressed, 4458 bytes compressed:  54.5%
...
-Filename: arglite-0.8.0.dist-info/LICENSE
+Filename: arglite-0.8.5.dist-info/LICENSE
 Comment: 
 
-Filename: arglite-0.8.0.dist-info/METADATA
+Filename: arglite-0.8.5.dist-info/METADATA
 Comment: 
 
-Filename: arglite-0.8.0.dist-info/WHEEL
+Filename: arglite-0.8.5.dist-info/WHEEL
 Comment: 
 
-Filename: arglite-0.8.0.dist-info/top_level.txt
+Filename: arglite-0.8.5.dist-info/top_level.txt
 Comment: 
 
-Filename: arglite-0.8.0.dist-info/RECORD
...
## Comparing `arglite-0.8.0.dist-info/LICENSE` & `arglite-0.8.5.dist-info/LICENSE`

 * *Files identical despite different names*

## Comparing `arglite-0.8.0.dist-info/METADATA` & `arglite-0.8.5.dist-info/METADATA`
...
## Comparing `arglite-0.8.0.dist-info/RECORD` & `arglite-0.8.5.dist-info/RECORD`
...
-arglite/arglite.py,sha256=Rr8O6ufsj8AR6VIwfiHLX2w_TkbXh5NQG9g9QFoXE-M,5124
...
-arglite-0.8.0.dist-info/LICENSE,sha256=fhLl30uuEsshWBuhV87SDhmGoFCN0Q0Oikq5pM-U6Fw,1211
-arglite-0.8.0.dist-info/METADATA,sha256=-PL2kMP9bIQaLHpBqTINdPRJNKSl0cT1z-xldpLQJwc,785
-arglite-0.8.0.dist-info/WHEEL,sha256=2wepM1nk4DS4eFpYrW1TTqPcoGNfHhhO_i5m4cOimbo,92
-arglite-0.8.0.dist-info/top_level.txt,sha256=arzqHSIoCtyjfK5QmzSD--Cxr2BO3A2zFy50JEko6iA,8
-arglite-0.8.0.dist-info/RECORD,,
