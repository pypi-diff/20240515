# Comparing `tmp/ado_wrapper-1.8.2.tar.gz` & `tmp/ado_wrapper-1.8.3.tar.gz`
...
### Comparing `ado_wrapper-1.8.2/ado_wrapper/client.py` & `ado_wrapper-1.8.3/ado_wrapper/client.py`
