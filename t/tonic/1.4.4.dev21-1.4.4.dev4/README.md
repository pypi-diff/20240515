# Comparing `tmp/tonic-1.4.4.dev21.tar.gz` & `tmp/tonic-1.4.4.dev4.tar.gz`
...
### Comparing `tonic-1.4.4.dev21/README.md` & `tonic-1.4.4.dev4/README.md`
...
### Comparing `tonic-1.4.4.dev21/docs/gallery/transformations/plot_drop_event.py` & `tonic-1.4.4.dev4/docs/gallery/transformations/plot_drop_event.py`
...
### Comparing `tonic-1.4.4.dev21/test/test_dsec.py` & `tonic-1.4.4.dev4/test/test_dsec.py`

 * *Files identical despite different names*

### Comparing `tonic-1.4.4.dev21/test/test_io.py` & `tonic-1.4.4.dev4/test/test_io.py`

 * *Files identical despite different names*

### Comparing `tonic-1.4.4.dev21/test/test_prototype_datasets.py` & `tonic-1.4.4.dev4/test/test_prototype_datasets.py`

 * *Files identical despite different names*

### Comparing `tonic-1.4.4.dev21/test/test_representations.py` & `tonic-1.4.4.dev4/test/test_representations.py`

 * *Files identical despite different names*

### Comparing `tonic-1.4.4.dev21/test/test_sliced_dataset.py` & `tonic-1.4.4.dev4/test/test_sliced_dataset.py`

 * *Files identical despite different names*

### Comparing `tonic-1.4.4.dev21/test/test_slicers.py` & `tonic-1.4.4.dev4/test/test_slicers.py`

 * *Files identical despite different names*

### Comparing `tonic-1.4.4.dev21/test/test_tonic_utils.py` & `tonic-1.4.4.dev4/test/test_tonic_utils.py`

 * *Files identical despite different names*

### Comparing `tonic-1.4.4.dev21/test/test_transforms.py` & `tonic-1.4.4.dev4/test/test_transforms.py`

 * *Files identical despite different names*

### Comparing `tonic-1.4.4.dev21/test/utils.py` & `tonic-1.4.4.dev4/test/utils.py`

 * *Files identical despite different names*

### Comparing `tonic-1.4.4.dev21/tonic/audio_transforms.py` & `tonic-1.4.4.dev4/tonic/audio_transforms.py`
...
### Comparing `tonic-1.4.4.dev21/tonic/cached_dataset.py` & `tonic-1.4.4.dev4/tonic/cached_dataset.py`

 * *Files identical despite different names*

### Comparing `tonic-1.4.4.dev21/tonic/collation.py` & `tonic-1.4.4.dev4/tonic/collation.py`

 * *Files identical despite different names*

### Comparing `tonic-1.4.4.dev21/tonic/dataset.py` & `tonic-1.4.4.dev4/tonic/dataset.py`

 * *Files identical despite different names*

### Comparing `tonic-1.4.4.dev21/tonic/datasets/__init__.py` & `tonic-1.4.4.dev4/tonic/datasets/__init__.py`
...
### Comparing `tonic-1.4.4.dev21/tonic/datasets/asl_dvs.py` & `tonic-1.4.4.dev4/tonic/datasets/asl_dvs.py`

 * *Files identical despite different names*

### Comparing `tonic-1.4.4.dev21/tonic/datasets/cifar10dvs.py` & `tonic-1.4.4.dev4/tonic/datasets/cifar10dvs.py`

 * *Files identical despite different names*

### Comparing `tonic-1.4.4.dev21/tonic/datasets/davisdataset.py` & `tonic-1.4.4.dev4/tonic/datasets/davisdataset.py`

 * *Files identical despite different names*

### Comparing `tonic-1.4.4.dev21/tonic/datasets/dsec.py` & `tonic-1.4.4.dev4/tonic/datasets/dsec.py`

 * *Files identical despite different names*

### Comparing `tonic-1.4.4.dev21/tonic/datasets/dvs_lips.py` & `tonic-1.4.4.dev4/tonic/datasets/dvs_lips.py`

 * *Files identical despite different names*

### Comparing `tonic-1.4.4.dev21/tonic/datasets/dvsgesture.py` & `tonic-1.4.4.dev4/tonic/datasets/dvsgesture.py`
...
### Comparing `tonic-1.4.4.dev21/tonic/datasets/ebssa.py` & `tonic-1.4.4.dev4/tonic/datasets/ebssa.py`
...
### Comparing `tonic-1.4.4.dev21/tonic/datasets/hsd.py` & `tonic-1.4.4.dev4/tonic/datasets/hsd.py`

 * *Files identical despite different names*

### Comparing `tonic-1.4.4.dev21/tonic/datasets/mvsec.py` & `tonic-1.4.4.dev4/tonic/datasets/mvsec.py`

 * *Files identical despite different names*

### Comparing `tonic-1.4.4.dev21/tonic/datasets/ncaltech101.py` & `tonic-1.4.4.dev4/tonic/datasets/ncaltech101.py`

 * *Files identical despite different names*

### Comparing `tonic-1.4.4.dev21/tonic/datasets/nmnist.py` & `tonic-1.4.4.dev4/tonic/datasets/nmnist.py`

 * *Files identical despite different names*

### Comparing `tonic-1.4.4.dev21/tonic/datasets/pokerdvs.py` & `tonic-1.4.4.dev4/tonic/datasets/pokerdvs.py`

 * *Files identical despite different names*

### Comparing `tonic-1.4.4.dev21/tonic/datasets/s_mnist.py` & `tonic-1.4.4.dev4/tonic/datasets/s_mnist.py`

 * *Files identical despite different names*

### Comparing `tonic-1.4.4.dev21/tonic/datasets/tum_vie.py` & `tonic-1.4.4.dev4/tonic/datasets/tum_vie.py`

 * *Files identical despite different names*

### Comparing `tonic-1.4.4.dev21/tonic/datasets/visual_place_recognition.py` & `tonic-1.4.4.dev4/tonic/datasets/visual_place_recognition.py`

 * *Files identical despite different names*

### Comparing `tonic-1.4.4.dev21/tonic/download_utils.py` & `tonic-1.4.4.dev4/tonic/download_utils.py`

 * *Files identical despite different names*

### Comparing `tonic-1.4.4.dev21/tonic/functional/__init__.py` & `tonic-1.4.4.dev4/tonic/functional/__init__.py`

 * *Files identical despite different names*

### Comparing `tonic-1.4.4.dev21/tonic/functional/crop.py` & `tonic-1.4.4.dev4/tonic/functional/crop.py`

 * *Files identical despite different names*

### Comparing `tonic-1.4.4.dev21/tonic/functional/decimate.py` & `tonic-1.4.4.dev4/tonic/functional/decimate.py`

 * *Files identical despite different names*

### Comparing `tonic-1.4.4.dev21/tonic/functional/denoise.py` & `tonic-1.4.4.dev4/tonic/functional/denoise.py`

 * *Files identical despite different names*

### Comparing `tonic-1.4.4.dev21/tonic/functional/drop_event.py` & `tonic-1.4.4.dev4/tonic/functional/drop_event.py`

 * *Files identical despite different names*

### Comparing `tonic-1.4.4.dev21/tonic/functional/drop_pixel.py` & `tonic-1.4.4.dev4/tonic/functional/drop_pixel.py`

 * *Files identical despite different names*

### Comparing `tonic-1.4.4.dev21/tonic/functional/event_downsampling.py` & `tonic-1.4.4.dev4/tonic/functional/event_downsampling.py`

 * *Files identical despite different names*

### Comparing `tonic-1.4.4.dev21/tonic/functional/refractory_period.py` & `tonic-1.4.4.dev4/tonic/functional/refractory_period.py`

 * *Files identical despite different names*

### Comparing `tonic-1.4.4.dev21/tonic/functional/spatial_jitter.py` & `tonic-1.4.4.dev4/tonic/functional/spatial_jitter.py`

 * *Files identical despite different names*

### Comparing `tonic-1.4.4.dev21/tonic/functional/time_jitter.py` & `tonic-1.4.4.dev4/tonic/functional/time_jitter.py`

 * *Files identical despite different names*

### Comparing `tonic-1.4.4.dev21/tonic/functional/time_skew.py` & `tonic-1.4.4.dev4/tonic/functional/time_skew.py`

 * *Files identical despite different names*

### Comparing `tonic-1.4.4.dev21/tonic/functional/to_averaged_timesurface.py` & `tonic-1.4.4.dev4/tonic/functional/to_averaged_timesurface.py`

 * *Files identical despite different names*

### Comparing `tonic-1.4.4.dev21/tonic/functional/to_bina_rep.py` & `tonic-1.4.4.dev4/tonic/functional/to_bina_rep.py`

 * *Files identical despite different names*

### Comparing `tonic-1.4.4.dev21/tonic/functional/to_frame.py` & `tonic-1.4.4.dev4/tonic/functional/to_frame.py`

 * *Files identical despite different names*

### Comparing `tonic-1.4.4.dev21/tonic/functional/to_timesurface.py` & `tonic-1.4.4.dev4/tonic/functional/to_timesurface.py`

 * *Files identical despite different names*

### Comparing `tonic-1.4.4.dev21/tonic/functional/to_voxel_grid.py` & `tonic-1.4.4.dev4/tonic/functional/to_voxel_grid.py`

 * *Files identical despite different names*

### Comparing `tonic-1.4.4.dev21/tonic/functional/uniform_noise.py` & `tonic-1.4.4.dev4/tonic/functional/uniform_noise.py`

 * *Files identical despite different names*

### Comparing `tonic-1.4.4.dev21/tonic/io.py` & `tonic-1.4.4.dev4/tonic/io.py`

 * *Files identical despite different names*

### Comparing `tonic-1.4.4.dev21/tonic/prototype/README.md` & `tonic-1.4.4.dev4/tonic/prototype/README.md`

 * *Files identical despite different names*

### Comparing `tonic-1.4.4.dev21/tonic/prototype/datasets/ncars.py` & `tonic-1.4.4.dev4/tonic/prototype/datasets/ncars.py`

 * *Files identical despite different names*

### Comparing `tonic-1.4.4.dev21/tonic/prototype/datasets/nmnist.py` & `tonic-1.4.4.dev4/tonic/prototype/datasets/nmnist.py`

 * *Files identical despite different names*

### Comparing `tonic-1.4.4.dev21/tonic/prototype/datasets/prophesee.py` & `tonic-1.4.4.dev4/tonic/prototype/datasets/prophesee.py`

 * *Files identical despite different names*

### Comparing `tonic-1.4.4.dev21/tonic/prototype/datasets/stmnist.py` & `tonic-1.4.4.dev4/tonic/prototype/datasets/stmnist.py`

 * *Files identical despite different names*

### Comparing `tonic-1.4.4.dev21/tonic/prototype/datasets/utils/_dataset.py` & `tonic-1.4.4.dev4/tonic/prototype/datasets/utils/_dataset.py`

 * *Files identical despite different names*

### Comparing `tonic-1.4.4.dev21/tonic/prototype/datasets/utils/_utils.py` & `tonic-1.4.4.dev4/tonic/prototype/datasets/utils/_utils.py`

 * *Files identical despite different names*

### Comparing `tonic-1.4.4.dev21/tonic/prototype/slicers.py` & `tonic-1.4.4.dev4/tonic/prototype/slicers.py`

 * *Files identical despite different names*

### Comparing `tonic-1.4.4.dev21/tonic/sliced_dataset.py` & `tonic-1.4.4.dev4/tonic/sliced_dataset.py`

 * *Files identical despite different names*

### Comparing `tonic-1.4.4.dev21/tonic/slicers.py` & `tonic-1.4.4.dev4/tonic/slicers.py`

 * *Files identical despite different names*

### Comparing `tonic-1.4.4.dev21/tonic/transforms.py` & `tonic-1.4.4.dev4/tonic/transforms.py`

 * *Files identical despite different names*

### Comparing `tonic-1.4.4.dev21/tonic/utils.py` & `tonic-1.4.4.dev4/tonic/utils.py`

 * *Files identical despite different names*

### Comparing `tonic-1.4.4.dev21/tonic-logo-padded.png` & `tonic-1.4.4.dev4/tonic-logo-padded.png`

 * *Files identical despite different names*

### Comparing `tonic-1.4.4.dev21/tonic.egg-info/PKG-INFO` & `tonic-1.4.4.dev4/tonic.egg-info/PKG-INFO`
...
### Comparing `tonic-1.4.4.dev21/tonic.egg-info/SOURCES.txt` & `tonic-1.4.4.dev4/tonic.egg-info/SOURCES.txt`
