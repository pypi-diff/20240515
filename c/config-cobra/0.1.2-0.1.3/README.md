# Comparing `tmp/config-cobra-0.1.2.tar.gz` & `tmp/config-cobra-0.1.3.tar.gz`

## filetype from file(1)

```diff
@@ -1 +1 @@
-gzip compressed data, was "config-cobra-0.1.2.tar", last modified: Wed May 15 14:16:02 2024, max compression
+gzip compressed data, was "config-cobra-0.1.3.tar", last modified: Wed May 15 14:45:40 2024, max compression
```

## Comparing `config-cobra-0.1.2.tar` & `config-cobra-0.1.3.tar`

### file list

```diff
@@ -1,30 +1,30 @@
-drwxrwxr-x   0 james     (1000) james     (1000)        0 2024-05-15 14:16:02.558188 config-cobra-0.1.2/
--rw-rw-r--   0 james     (1000) james     (1000)     1062 2024-05-14 18:17:06.000000 config-cobra-0.1.2/LICENSE
--rw-rw-r--   0 james     (1000) james     (1000)     3353 2024-05-15 14:16:02.558188 config-cobra-0.1.2/PKG-INFO
--rw-rw-r--   0 james     (1000) james     (1000)     3110 2024-05-15 14:14:53.000000 config-cobra-0.1.2/README.md
-drwxrwxr-x   0 james     (1000) james     (1000)        0 2024-05-15 14:16:02.558188 config-cobra-0.1.2/config_cobra.egg-info/
--rw-rw-r--   0 james     (1000) james     (1000)     3353 2024-05-15 14:16:02.000000 config-cobra-0.1.2/config_cobra.egg-info/PKG-INFO
--rw-rw-r--   0 james     (1000) james     (1000)      502 2024-05-15 14:16:02.000000 config-cobra-0.1.2/config_cobra.egg-info/SOURCES.txt
--rw-rw-r--   0 james     (1000) james     (1000)        1 2024-05-15 14:16:02.000000 config-cobra-0.1.2/config_cobra.egg-info/dependency_links.txt
--rw-rw-r--   0 james     (1000) james     (1000)       47 2024-05-15 14:16:02.000000 config-cobra-0.1.2/config_cobra.egg-info/entry_points.txt
--rw-rw-r--   0 james     (1000) james     (1000)      215 2024-05-15 14:16:02.000000 config-cobra-0.1.2/config_cobra.egg-info/requires.txt
--rw-rw-r--   0 james     (1000) james     (1000)       10 2024-05-15 14:16:02.000000 config-cobra-0.1.2/config_cobra.egg-info/top_level.txt
--rw-rw-r--   0 james     (1000) james     (1000)       38 2024-05-15 14:16:02.558188 config-cobra-0.1.2/setup.cfg
--rw-rw-r--   0 james     (1000) james     (1000)      702 2024-05-15 14:15:53.000000 config-cobra-0.1.2/setup.py
-drwxrwxr-x   0 james     (1000) james     (1000)        0 2024-05-15 14:16:02.558188 config-cobra-0.1.2/src/
--rw-rw-r--   0 james     (1000) james     (1000)        0 2024-05-14 12:14:48.000000 config-cobra-0.1.2/src/__init__.py
--rw-rw-r--   0 james     (1000) james     (1000)     1107 2024-05-14 18:08:03.000000 config-cobra-0.1.2/src/app.py
-drwxrwxr-x   0 james     (1000) james     (1000)        0 2024-05-15 14:16:02.558188 config-cobra-0.1.2/src/db/
--rw-rw-r--   0 james     (1000) james     (1000)       93 2024-05-14 18:00:13.000000 config-cobra-0.1.2/src/db/__init__.py
--rw-rw-r--   0 james     (1000) james     (1000)     1259 2024-05-14 16:49:00.000000 config-cobra-0.1.2/src/db/database_instance.py
-drwxrwxr-x   0 james     (1000) james     (1000)        0 2024-05-15 14:16:02.558188 config-cobra-0.1.2/src/runner/
--rw-rw-r--   0 james     (1000) james     (1000)       39 2024-05-14 13:20:33.000000 config-cobra-0.1.2/src/runner/__init__.py
--rw-rw-r--   0 james     (1000) james     (1000)     5140 2024-05-14 18:08:55.000000 config-cobra-0.1.2/src/runner/update_runner.py
-drwxrwxr-x   0 james     (1000) james     (1000)        0 2024-05-15 14:16:02.558188 config-cobra-0.1.2/src/settings/
--rw-rw-r--   0 james     (1000) james     (1000)        0 2024-05-14 13:11:52.000000 config-cobra-0.1.2/src/settings/__init__.py
--rw-rw-r--   0 james     (1000) james     (1000)      301 2024-05-14 18:12:45.000000 config-cobra-0.1.2/src/settings/settings.py
-drwxrwxr-x   0 james     (1000) james     (1000)        0 2024-05-15 14:16:02.558188 config-cobra-0.1.2/tests/
--rw-rw-r--   0 james     (1000) james     (1000)        0 2024-05-14 12:30:51.000000 config-cobra-0.1.2/tests/__init__.py
-drwxrwxr-x   0 james     (1000) james     (1000)        0 2024-05-15 14:16:02.558188 config-cobra-0.1.2/tests/runner/
--rw-rw-r--   0 james     (1000) james     (1000)        0 2024-05-14 16:29:23.000000 config-cobra-0.1.2/tests/runner/__init__.py
--rw-rw-r--   0 james     (1000) james     (1000)     2174 2024-05-14 18:03:12.000000 config-cobra-0.1.2/tests/runner/update_runner_unit_test.py
...
### Comparing `config-cobra-0.1.2/LICENSE` & `config-cobra-0.1.3/LICENSE`

 * *Files identical despite different names*

### Comparing `config-cobra-0.1.2/PKG-INFO` & `config-cobra-0.1.3/PKG-INFO`
...
### Comparing `config-cobra-0.1.2/README.md` & `config-cobra-0.1.3/README.md`
...
### Comparing `config-cobra-0.1.2/config_cobra.egg-info/PKG-INFO` & `config-cobra-0.1.3/config_cobra.egg-info/PKG-INFO`
...
### Comparing `config-cobra-0.1.2/setup.py` & `config-cobra-0.1.3/setup.py`
...
### Comparing `config-cobra-0.1.2/src/app.py` & `config-cobra-0.1.3/src/app.py`

 * *Files identical despite different names*

### Comparing `config-cobra-0.1.2/src/db/database_instance.py` & `config-cobra-0.1.3/src/db/database_instance.py`

 * *Files identical despite different names*

### Comparing `config-cobra-0.1.2/src/runner/update_runner.py` & `config-cobra-0.1.3/src/runner/update_runner.py`

 * *Files identical despite different names*

### Comparing `config-cobra-0.1.2/tests/runner/update_runner_unit_test.py` & `config-cobra-0.1.3/tests/runner/update_runner_unit_test.py`
