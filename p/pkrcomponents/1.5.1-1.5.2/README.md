# Comparing `tmp/pkrcomponents-1.5.1.tar.gz` & `tmp/pkrcomponents-1.5.2.tar.gz`
...
### Comparing `pkrcomponents-1.5.1/pkrcomponents/_common.py` & `pkrcomponents-1.5.2/pkrcomponents/_common.py`
