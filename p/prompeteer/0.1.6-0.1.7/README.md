# Comparing `tmp/prompeteer-0.1.6.tar.gz` & `tmp/prompeteer-0.1.7.tar.gz`
...
## Comparing `prompeteer-0.1.6.tar` & `prompeteer-0.1.7.tar`
...
### Comparing `prompeteer-0.1.6/PKG-INFO` & `prompeteer-0.1.7/PKG-INFO`
...
### Comparing `prompeteer-0.1.6/README.md` & `prompeteer-0.1.7/README.md`

 * *Files identical despite different names*

### Comparing `prompeteer-0.1.6/prompeteer.egg-info/PKG-INFO` & `prompeteer-0.1.7/prompeteer.egg-info/PKG-INFO`
...
### Comparing `prompeteer-0.1.6/prompeteer.py` & `prompeteer-0.1.7/prompeteer.py`

 * *Files identical despite different names*

### Comparing `prompeteer-0.1.6/setup.py` & `prompeteer-0.1.7/setup.py`
