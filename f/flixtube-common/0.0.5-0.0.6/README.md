# Comparing `tmp/flixtube_common-0.0.5.tar.gz` & `tmp/flixtube_common-0.0.6.tar.gz`
...
## Comparing `flixtube_common-0.0.5.tar` & `flixtube_common-0.0.6.tar`
...
### Comparing `flixtube_common-0.0.5/src/flixtube_common/cosmosdb/db_operations.py` & `flixtube_common-0.0.6/src/flixtube_common/cosmosdb/db_operations.py`

 * *Files identical despite different names*

### Comparing `flixtube_common-0.0.5/src/flixtube_common/rabbitmq/pika_client.py` & `flixtube_common-0.0.6/src/flixtube_common/rabbitmq/pika_client.py`
