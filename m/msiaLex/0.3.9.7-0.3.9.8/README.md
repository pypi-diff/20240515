# Comparing `tmp/msiaLex-0.3.9.7-py3-none-any.whl.zip` & `tmp/msiaLex-0.3.9.8-py3-none-any.whl.zip`
...
```diff
@@ -1,28 +1,37 @@
+Filename: data/Emoji_Sentiment_Data_v1.0.csv
+Comment: 
+
...
## Comparing `msiaLex-0.3.9.7.dist-info/LICENSE.txt` & `msiaLex-0.3.9.8.dist-info/LICENSE.txt`

 * *Files identical despite different names*

## Comparing `msiaLex-0.3.9.7.dist-info/METADATA` & `msiaLex-0.3.9.8.dist-info/METADATA`
...
## Comparing `msiaLex-0.3.9.7.dist-info/RECORD` & `msiaLex-0.3.9.8.dist-info/RECORD`
