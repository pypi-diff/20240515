# Comparing `tmp/rigging-1.0.0.tar.gz` & `tmp/rigging-1.0.0rc0.tar.gz`

## filetype from file(1)

```diff
@@ -1 +1 @@
-gzip compressed data, was "rigging-1.0.0.tar", max compression
+gzip compressed data, was "rigging-1.0.0rc0.tar", max compression
```

## Comparing `rigging-1.0.0.tar` & `rigging-1.0.0rc0.tar`

### file list

```diff
@@ -1,17 +1,16 @@
--rw-r--r--   0        0        0     1066 2024-05-15 00:44:09.946384 rigging-1.0.0/LICENSE
--rw-r--r--   0        0        0     1479 2024-05-15 00:44:09.950384 rigging-1.0.0/README.md
--rw-r--r--   0        0        0     2392 2024-05-15 00:44:09.954384 rigging-1.0.0/pyproject.toml
--rw-r--r--   0        0        0      730 2024-05-15 00:44:09.954384 rigging-1.0.0/rigging/__init__.py
--rw-r--r--   0        0        0    41559 2024-05-15 00:44:09.954384 rigging-1.0.0/rigging/chat.py
--rw-r--r--   0        0        0    26509 2024-05-15 00:44:09.954384 rigging-1.0.0/rigging/completion.py
--rw-r--r--   0        0        0     3110 2024-05-15 00:44:09.954384 rigging-1.0.0/rigging/data.py
--rw-r--r--   0        0        0      865 2024-05-15 00:44:09.954384 rigging-1.0.0/rigging/error.py
--rw-r--r--   0        0        0    19086 2024-05-15 00:44:09.954384 rigging-1.0.0/rigging/generator.py
--rw-r--r--   0        0        0     1791 2024-05-15 00:44:09.954384 rigging-1.0.0/rigging/logging.py
--rw-r--r--   0        0        0    13768 2024-05-15 00:44:09.954384 rigging-1.0.0/rigging/message.py
--rw-r--r--   0        0        0    12573 2024-05-15 00:44:09.954384 rigging-1.0.0/rigging/model.py
--rw-r--r--   0        0        0     3748 2024-05-15 00:44:09.954384 rigging-1.0.0/rigging/parsing.py
--rw-r--r--   0        0        0     1090 2024-05-15 00:44:09.954384 rigging-1.0.0/rigging/prompt.py
--rw-r--r--   0        0        0        0 2024-05-15 00:44:09.954384 rigging-1.0.0/rigging/py.typed
--rw-r--r--   0        0        0    10466 2024-05-15 00:44:09.954384 rigging-1.0.0/rigging/tool.py
--rw-r--r--   0        0        0     2251 1970-01-01 00:00:00.000000 rigging-1.0.0/PKG-INFO
...
### Comparing `rigging-1.0.0/LICENSE` & `rigging-1.0.0rc0/LICENSE`

 * *Files identical despite different names*

### Comparing `rigging-1.0.0/README.md` & `rigging-1.0.0rc0/README.md`
...
### Comparing `rigging-1.0.0/pyproject.toml` & `rigging-1.0.0rc0/pyproject.toml`
...
### Comparing `rigging-1.0.0/rigging/__init__.py` & `rigging-1.0.0rc0/rigging/__init__.py`
...
### Comparing `rigging-1.0.0/rigging/chat.py` & `rigging-1.0.0rc0/rigging/chat.py`
...
### Comparing `rigging-1.0.0/rigging/completion.py` & `rigging-1.0.0rc0/rigging/completion.py`
...
### Comparing `rigging-1.0.0/rigging/error.py` & `rigging-1.0.0rc0/rigging/error.py`

 * *Files identical despite different names*

### Comparing `rigging-1.0.0/rigging/generator.py` & `rigging-1.0.0rc0/rigging/generator.py`
...
### Comparing `rigging-1.0.0/rigging/logging.py` & `rigging-1.0.0rc0/rigging/logging.py`
...
### Comparing `rigging-1.0.0/rigging/message.py` & `rigging-1.0.0rc0/rigging/message.py`
...
### Comparing `rigging-1.0.0/rigging/model.py` & `rigging-1.0.0rc0/rigging/model.py`

 * *Files identical despite different names*

### Comparing `rigging-1.0.0/rigging/parsing.py` & `rigging-1.0.0rc0/rigging/parsing.py`

 * *Files identical despite different names*

### Comparing `rigging-1.0.0/rigging/prompt.py` & `rigging-1.0.0rc0/rigging/prompt.py`

 * *Files identical despite different names*

### Comparing `rigging-1.0.0/rigging/tool.py` & `rigging-1.0.0rc0/rigging/tool.py`
...
### Comparing `rigging-1.0.0/PKG-INFO` & `rigging-1.0.0rc0/PKG-INFO`
